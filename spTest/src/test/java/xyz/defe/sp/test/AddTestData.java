...
public class AddTestData {
    ...
    void addProducts(){
        List products = List.of(
                new Product("Computer", new BigDecimal(3500.00), 10000000, new Date()),
                new Product("Cell Phone", new BigDecimal(1100.00), 10000000, new Date()),
                new Product("Bike", new BigDecimal(500.00), 10000000, new Date())
        );
